...
graph LR
    ...
    style Restart fill:#e6710b,stroke:#fff,stroke-width:2px,color:#fff
    style Stop fill:#32149c,stroke:#fff,stroke-width:2px,color:#fff
    style Exit fill:#1d3f85,color:#fff
    style PolicyS fill:#1d3f85,color:#fff
    style PolicyF fill:#1d3f85,color:#fff
```

...
But in Service Discovery provides a **stable way for applications to find and communicate with each other** inside the cluster.

# Add upsteam and Downstream consept here ?
---
